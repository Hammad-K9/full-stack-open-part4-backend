...
describe('favorite blog', () => {
  ...
  test('when list has multiple blogs, returns object with most likes', () => {
...
describe('most blogs', () => {
  test('when list has only 1 blog, return object with author and 1 blog', () => {
  ...
  test('when list has multiple blogs, return author and blog as object', () => {
...
describe('most likes', () => {
  test('when list has only one blog, return author and likes as object', () => {
